...
public class GeneratePdfReport {
    ...
    public static ByteArrayInputStream citiesReport(List<Customer> customers) {
        ...
        try {
            ...
            hcell = new PdfPCell(new Phrase("EsiId", headFont));
            hcell.setHorizontalAlignment(Element.ALIGN_CENTER);
            table.addCell(hcell);
            ...
            for (Customer customer : customers) {
                ...
                cell = new PdfPCell(new Phrase(String.valueOf(customer.getEsiId())));
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
